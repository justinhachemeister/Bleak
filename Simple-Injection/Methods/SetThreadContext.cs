    ...
    internal static class SetThreadContext
    {
        ...
        private static bool Inject(string dllPath, Process process)
        {
            ...
            if (!compiledAsx64)
            {
                ...
                var shellcode = Shellcode.CallLoadLibraryx86(instructionPointer, dllNameAddress, loadLibraryAddress);
            ...
            else
            {
                ...
                var shellcode = Shellcode.CallLoadLibraryx64(instructionPointer, dllNameAddress, loadLibraryAddress);
