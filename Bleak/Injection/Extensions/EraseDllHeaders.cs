...
{
    internal class EraseDllHeaders : IInjectionExtension
    {
        public bool Call(InjectionProperties injectionProperties)
        {
            ...
            injectionProperties.MemoryManager.WriteVirtualMemory(module.BaseAddress, new byte[(int) memoryInformation.RegionSize]);
