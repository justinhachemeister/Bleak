...
namespace Bleak.Methods
{
    internal static class NtCreateThreadEx
    {
        ...
        private static bool Inject(string dllPath, Process process)
        {
            ...
            NtCreateThreadEx(out var remoteThreadHandle, AccessMask.SpecificRightsAll | AccessMask.StandardRightsAll, IntPtr.Zero, processHandle, loadLibraryAddress, dllNameAddress, CreationFlags.HideFromDebugger, 0, 0, 0, IntPtr.Zero);
