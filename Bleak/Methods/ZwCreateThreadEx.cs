...
namespace Bleak.Methods
{
    internal class ZwCreateThreadEx
    {
        ...
        internal bool Inject(Process process, string dllPath)
        {
            ...
            ZwCreateThreadEx(out var remoteThreadHandle, AccessMask.SpecificRightsAll | AccessMask.StandardRightsAll, IntPtr.Zero, processHandle, loadLibraryAddress, dllPathAddress, CreationFlags.HideFromDebugger, 0, 0, 0, IntPtr.Zero);
