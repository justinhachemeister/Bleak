...
{
     internal static class ZwCreateThreadEx
    {
        ...
        private static bool Inject(string dllPath, Process process)
        {
            ...
            ZwCreateThreadEx(out var remoteThreadHandle, AccessMask.SpecificRightsAll | AccessMask.StandardRightsAll, IntPtr.Zero, processHandle, loadLibraryAddress, dllNameAddress, CreationFlags.HideFromDebugger, 0, 0, 0, IntPtr.Zero);
